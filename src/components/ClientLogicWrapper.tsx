...
function ClientLogicWrapperContent({
    ...
    useEffect(() => {
        ...
        console.log("📍 Route Check:", { isGetMeInterview, isSignup, isBookDemo });
        ...
        if (isGetMeInterview || isSignup || isBookDemo) {
            ...
            // For /get-me-interview route: only show modal automatically if URL has query params
            // This prevents modal from showing on refresh when URL is clean (no query params)
            if (isGetMeInterview && !searchParams.toString()) {
                console.log("🚫 No query params on /get-me-interview, not showing modal automatically");
                return;
            }
    ...
    const handleGeoBlockModalClose = () => {
        ...
        // Clean URL by removing query params when on /get-me-interview
